...
* **1)In the future, it would be beneficial to include more MLH scenes from different contexts (e.g., observations from different times, regions, environments)**. Providing more complex scenes in different regions could provide more context for the algorithm. Field campaigns such as ACTIVATE(2020), ACTIVATE (2021), ACTIVATE (2022), CAMP2Ex (2019), LISTOS (2018), TRACER-AQ (2021), and CPEX-CV (2022) could be incorporated into such an algorithm. 
